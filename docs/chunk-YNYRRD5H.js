import { a as b, b as h, c as it, d as N } from './chunk-D5WR2F3S.js'
var T = /([^\s\\>"'=]+)\s*=\s*(['"]?)$/,
  ...
  V = /<([a-z]+[a-z0-9:._-]*)([^>]*?)(\/>)/gi,
  tt = /\s+$/,
  L = (t, e) => 0 < e-- && (Y.test(t[e]) || (!Z.test(t[e]) && L(t, e))),
      ...
      i = n
        ...
        : function (c) {
            ...
            if (/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(c)) {
              var d = RegExp.$1
              ;(f.innerHTML = '<table>' + c + '</table>'), (u = f.querySelectorAll(d))
...
var z = y.length != 1,
  D = z ? (t, e, r) => y.call(document, E(t, e, r), !0) : E,
  q = z
    ? (t) => R.call(document, t, 1 | 128, null, !1)
    : (t) => R.call(document, t, 1 | 128)
var m = (t, e, r) => j(t.parentNode, e, r, k, t),
  ct = (t) => {
    let e,
      r,
      n = [],
      i = (o) => {
        switch (typeof o) {
          ...
          case 'undefined':
            ...
            e !== o &&
              'ELEMENT_NODE' in o &&
              ((e = o), (n = m(t, n, o.nodeType === 11 ? N.call(o.childNodes) : [o])))
            break
          case 'function':
            i(o(t))
            break
  ...
  lt = (t, e) => {
    switch (e[0]) {
      case '?':
        return W(t, e.slice(1), !1)
      case '.':
        return _(t, e.slice(1))
      case '@':
        return A(t, 'on' + e.slice(1))
      case 'o':
        if (e[1] === 'n') return A(t, e)
    }
    switch (e) {
      case 'ref':
        return P(t)
...
var { create: dt, defineProperties: ht } = Object,
  J = (t) => {
    ...
    return ht((n, ...i) => new $(t, n, i), {
      ...
      node: {
        value: (n, ...i) => g(p(), { type: t, template: n, values: i }).valueOf(),
      },
    })
  },
  K = b(new WeakMap()),
  ...
  Dt = J('html'),
  qt = J('svg')
export { E as a, zt as b, Dt as c, qt as d }
/*! (c) Andrea Giammarchi - ISC */
//# sourceMappingURL=chunk-YNYRRD5H.js.map
